...
# CoLA finetuning. Hyperparameters are taken from RoBERTa paper.
...
SAVE_DIR="checkpoints-COLA/"    
                                                                                                                                                                                                                                                                                                                                                                                                                     
CUDA_VISIBLE_DEVICES=0 TASK_QUEUE_ENABLE=0 fairseq-train CoLA-bin/ \
    --save-dir $SAVE_DIR \
    ...
    --best-checkpoint-metric accuracy --maximize-best-checkpoint-metric --seed 2157