...
# QNLI finetuning. Hyperparameters are taken from RoBERTa paper.
...
SAVE_DIR="checkpoints-QNLI/"    
                                                                                                                                                                                                                                                                                                                                                                                                                     
CUDA_VISIBLE_DEVICES=0 TASK_QUEUE_ENABLE=0 fairseq-train QNLI-bin/ \
