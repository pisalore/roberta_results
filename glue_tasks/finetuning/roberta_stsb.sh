...
# STSB finetuning. Hyperparameters are taken from RoBERTa paper.
...
SAVE_DIR="checkpoints-STS-B/"    
                                                                                                                                                                                                                                                                                                                                                                                                                     
CUDA_VISIBLE_DEVICES=0 TASK_QUEUE_ENABLE=0 fairseq-train STS-B-bin/ \
    --save-dir $SAVE_DIR \
